  ...
  const { data: order, isLoading, isError } = useQuery({
    ...
    queryFn: async () => {
      ...
      return {
        ...
        subscription_username: dbOrder.status === "fulfilled" ? (dbOrder.subscription_username as string | null) : null,
        subscription_password: dbOrder.status === "fulfilled" ? (dbOrder.subscription_password as string | null) : null,
        subscription_url: dbOrder.status === "fulfilled" ? (dbOrder.subscription_url as string | null) : null,
        subscription_extra_info: dbOrder.status === "fulfilled" ? ((dbOrder.subscription_extra_info as Record<string, unknown> | null) ?? null) : null,
      };
    },
    retry: shouldRetry,
  });
